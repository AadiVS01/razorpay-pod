                      ...
                      products: {
                        ...
                        items: {
                          ...
                          properties: {
                            ...
                            image_url: { type: "string", format: "uri", description: "Direct public HTTPS image URL. When presenting or recommending products to the user in chat, you MUST render this image inline using Markdown: ![Product Name](image_url). Do NOT use plain text links." },
                            image_markdown: { type: "string", description: "Pre-formatted Markdown image tag (e.g. ![Name](url)). Output this exact string in your chat response to render the product photo." },
